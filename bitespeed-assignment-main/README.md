...
## Option 1: Run Locally (Node + Docker Postgres)
...
## Option 2: Run Entire Project Using Docker Compose (Recommended)

This runs both the application and PostgreSQL together.
...
No additional setup or `.env` file is required for Docker Compose.
